var starboardWrap = (function (exports) {
  ...
  function loadDefaultSettings(opts, el) {
      ...
      return {
          ...
          sandbox: (_f = (_e = opts.sandbox) !== null && _e !== void 0 ? _e : el.getAttribute("sandbox")) !== null && _f !== void 0 ? _f : "allow-scripts allow-modals allow-same-origin allow-pointer-lock allow-top-navigation-by-user-activation allow-forms allow-downloads allow-popups",
